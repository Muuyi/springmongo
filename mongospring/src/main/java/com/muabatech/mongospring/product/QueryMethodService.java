...
public class QueryMethodService {
	...
	public List<Product> searchyName(String name){
	...
	public List<Product> searchAndSortAsc(String name){
		return repository.findAllByNameContainingIgnoreCaseOrderByPriceDesc(name);
	}
	public List<Product> sortAndPageByField(String name,int pageNumber,int size){
		Pageable page = PageRequest.of(0, 2);
		return repository.findAllByNameContainingIgnoreCaseOrderByPriceDesc(name,page);
	}
